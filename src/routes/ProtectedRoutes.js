...
import ManagePayrolls from "../apps/managepayrolls";
import Contacts from "../apps/Contacts";
import Chat from "../apps/Chat";
import AppCalendar from "../apps/AppCalendar";
import Email from "../apps/Email";
import FileManager from "../apps/FileManager";
import ClockInClockOutPage from "../apps/clockinclockout";
...
import MyPayrollsPage from "../apps/MyPayrolls";
import UsersClockEntriesPage from "../apps/UsersClockEntriesPage";
import ManageAllLeaves from "../dashboard/ManageAllLeaves";
import PaycheckCalculator from "../dashboard/PaycheckCalculator";
...
const protectedRoutes = [
  ...
  { path: "dashboard/allleaves", element: <ManageAllLeaves /> },
  ...
  { path: "apps/mypayrolls", element: <MyPayrollsPage /> },
  { path: "dashboard/paycheckcalculator", element: <PaycheckCalculator /> },
  
  { path: "apps/userclocks", element: <UsersClockEntriesPage /> },
  
  { path: "apps/clockinclockout", element: <ClockInClockOutPage /> },

  { path: "apps/manage-payrolls", element: <ManagePayrolls /> },
